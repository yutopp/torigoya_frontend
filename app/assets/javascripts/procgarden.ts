...
module ProcGarden {
    ...
    export class ResultHolder {
        ...
        public set(result: Model.Status) {
            ...
            if ( result.used_cpu_time_sec != undefined ) {
                this.cpu        = result.used_cpu_time_sec;
            }
            if ( result.used_memory_bytes != undefined ) {
            ...
            if ( result.cpu_time_sec_limit != undefined ) {
                this.cpu_limit = result.cpu_time_sec_limit;
            }
            if ( result.memory_bytes_limit != undefined ) {
